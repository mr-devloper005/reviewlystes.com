...
const inputClass = 'h-12 rounded-md border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#202125] outline-none transition placeholder:text-[#777] focus:border-[var(--slot4-accent)] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[var(--slot4-accent,#f0a11f)] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
