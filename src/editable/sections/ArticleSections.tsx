  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-12 sm:pt-16 lg:pt-20`}>
        <div className={`editable-news-module rounded-md ${pal.darkBg} p-7 text-white sm:p-10 lg:p-14`}>
          <p className="editable-section-heading text-xs font-black uppercase tracking-[0.18em] text-[var(--slot4-accent)]">{voice.eyebrow}</p>
  ...
  return (
    <main className={dc.shell.page}>
      <section className={`${dc.shell.section} pt-10 sm:pt-14 lg:pt-16`}>
        <div className="editable-news-module grid gap-6 rounded-md bg-white p-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:p-10">
      ...
      <section className="mx-auto w-full max-w-5xl px-4 pb-16 pt-6 sm:px-6 lg:px-8 lg:pb-24">
        <div className="editable-news-module rounded-md bg-white p-6 sm:p-8 lg:p-10">
